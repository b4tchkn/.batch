...
function createPackage(rootPath) {
    ...
    if (fs.existsSync(projectPackageFile)) {
        ...
        let projectPackage = new package_1.Package(packageDependenciesContractsDirectory);
...
function createDefaultPackage(packagePath) {
    let defaultPackage = new package_1.Package(packageDependenciesContractsDirectory);
