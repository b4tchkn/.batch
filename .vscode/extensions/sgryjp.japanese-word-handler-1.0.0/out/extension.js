...
function cursorNextWordEndJa(editor, wordSeparators) {
    const pos = positionOfNextWordEnd(editor.document, editor.selection.active, wordSeparators);
...
function cursorNextWordEndSelectJa(editor, wordSeparators) {
    ...
    const pos = positionOfNextWordEnd(editor.document, editor.selection.active, wordSeparators);
    editor.selections = [new vscode_1.Selection(anchorPos, pos)];
}
exports.cursorNextWordEndSelectJa = cursorNextWordEndSelectJa;
function cursorPrevWordStartJa(editor, wordSeparators) {
    const pos = positionOfPrevWordStart(editor.document, editor.selection.active, wordSeparators);
    editor.selections = [new vscode_1.Selection(pos, pos)];
}
